	...
	public partial class Surveya5 : ComponentBase
	{
		...
		protected override async Task OnInitializedAsync()
		{
			...
			foreach (var item in modelSurA2sByHc)
			{
				...
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_0=  String.IsNullOrEmpty(item.survey_A1.a16_0) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_1 = String.IsNullOrEmpty(item.survey_A1.a16_2) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_2 = String.IsNullOrEmpty(item.survey_A1.a16_2) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_3 = String.IsNullOrEmpty(item.survey_A1.a16_3) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_4 = String.IsNullOrEmpty(item.survey_A1.a16_4) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_5 = String.IsNullOrEmpty(item.survey_A1.a16_5) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_6 = String.IsNullOrEmpty(item.survey_A1.a16_6) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_7 = String.IsNullOrEmpty(item.survey_A1.a16_7) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_8 = String.IsNullOrEmpty(item.survey_A1.a16_8) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_9 = String.IsNullOrEmpty(item.survey_A1.a16_9) ? false : true;
				modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_10 =String.IsNullOrEmpty(item.survey_A1.a16_10) ? false : true;
				index++;
		...
		protected async Task HandleValidSubmit(EditContext context)
		{
			...
			foreach (var item in modelSurA2sByHc)
			{
				modelSurA2sByHc.ElementAt(index).survey_A1.a16_0 = modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_0 ? "0" : "";
				modelSurA2sByHc.ElementAt(index).survey_A1.a16_1 = modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_1 ? "1" : "0";   
				modelSurA2sByHc.ElementAt(index).survey_A1.a16_2 = modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_2 ? "2" : "";
				modelSurA2sByHc.ElementAt(index).survey_A1.a16_3 = modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_3 ? "3" : "";
				modelSurA2sByHc.ElementAt(index).survey_A1.a16_4 = modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_4 ? "4" : "";
				modelSurA2sByHc.ElementAt(index).survey_A1.a16_5 = modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_5 ? "5" : "";
				modelSurA2sByHc.ElementAt(index).survey_A1.a16_6 = modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_6 ? "6" : "";
				modelSurA2sByHc.ElementAt(index).survey_A1.a16_7 = modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_7 ? "7" : "";
				modelSurA2sByHc.ElementAt(index).survey_A1.a16_8 = modelSurA2sByHc.ElementAt(index).checkSurveya2.a16_8 ? "8" : "";
			...
			await DBContext.AddItems<log_file>("log_file", new List<log_file> {
					new log_file {
						...
						detail="แก้ไข $HC ตอนที่ 1 5/5')"
						} });
			StateHasChanged();
		}
		private async Task gotoPage(string HC_nextPage)
		{
			NavigationManager.NavigateTo("/surveyb1/" + HC_nextPage);
		}
	}
}
